...
consvar_t cv_allownewplayer = {"allowjoin", "On", CV_NETVAR, CV_OnOff, Joinable_OnChange, 0, NULL, NULL, 0, 0, NULL	};
consvar_t cv_joinnextround = {"joinnextround", "Off", CV_NETVAR, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL}; /// \todo not done
static CV_PossibleValue_t maxplayers_cons_t[] = {{2, "MIN"}, {32, "MAX"}, {0, NULL}};
consvar_t cv_maxplayers = {"maxplayers", "8", CV_SAVE, maxplayers_cons_t, Joinable_OnChange, 0, NULL, NULL, 0, 0, NULL};
